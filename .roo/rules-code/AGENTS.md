...
- Always use async/await for database operations - aiosqlite requires async patterns
...
- Database engine has typo: use `enging` (not `engine`) when accessing from `app.dao.database`
